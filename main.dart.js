...
import 'providers/marketing_dashboard_provider.dart'; // [NEW] 마케팅 대시보드 프로바이더
...
// [NEW] 마케팅 대시보드 페이지 imports
// import 'screens/marketing/marketing_dashboard_page.dart';
// import 'screens/marketing/team_members_page.dart';
// import 'screens/marketing/tasks_list_page.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      routes: {
        ...
        // [NEW] 마케팅 대시보드 라우트
        // '/marketing/dashboard': (_) => const MarketingDashboardPage(),
        // '/marketing/members':   (_) => const TeamMembersPage(),
        // '/marketing/tasks':     (_) => const TasksListPage(),
      },
...
class _AppRouterState extends State<_AppRouter> {
  ...
  void _handleAuthChange() {
    ...
    // [NEW] 마케팅 대시보드 프로바이더
    final marketing = context.read<MarketingDashboardProvider>();
    ...
    Future.microtask(() async {
      ...
      if (app.selectedTeam != null) {
        await marketing.loadTeamData(app.selectedTeam!.id);
      }
...
// ─────────────────────────────────────────────────────────────
//  [NEW] MarketingDashboardProvider 초기화
//  추가 정보: providers/marketing_dashboard_provider.dart 파일 참조
// ─────────────────────────────────────────────────────────────
